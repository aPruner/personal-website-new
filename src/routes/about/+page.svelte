...
<p class="mb-4 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
	I'm a software generalist who specializes in full stack web applications and likes to build games
	for fun. I'm currently contributing my expertise to the growth engineering team at
...
>
	...
	<svg
		...
		stroke-width="1.5"
		stroke="currentColor"
		class="ml-1.5 mt-1 mb-0.5 w-6 h-6"
	>
		<path
